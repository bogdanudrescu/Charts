...
public class Color implements Serializable {
	...
	private void checkRange(int red, int green, int blue, int alpha) {
		if (!withinRange(red) || !withinRange(green) || !withinRange(blue) || !withinRange(alpha)) {
			...
			String errorMessage = "All values must fall within range [0-255]. (red: " + red + ", green: " + green + ", blue: " + blue + ", alpha: "
					+ alpha + ")";
	...
	public static int HSLtoRGB(int hue, int saturation, int lightness) {
		...
		if (saturationRatio == 0) {
			...
			float p = lightnessRatio < 0.5f ? lightnessRatio * (1f + saturationRatio) : lightnessRatio + saturationRatio - lightnessRatio
					* saturationRatio;
